...
function ScenesInfo() {
    ...
    const [strength, setStrength] = useState(tempStr);
    const [dexterity, setDexterity] = useState(tempDex);
    const [constitution, setConstitution] = useState(tempCon);
    const [intelligence, setIntelligence] = useState(tempInt);
    const [wisdom, setWisdom] = useState(tempWis);
    const [charisma, setCharisma] = useState(tempCha);
            ...
            <div className='other_options'>
                ...
                <div>
                    <div>
                        ...
                        <input type='number' defaultValue={1} min={1} max={9} value={strength} onChange={e => setStrength(parseInt(e.target.value))} />
                    </div>
                    <div>
                        <label>Dexerity?</label>
                        <input type='number' defaultValue={1} min={1} max={9} value={dexterity} onChange={e => setDexterity(parseInt(e.target.value))} />
                    </div>
                    <div>
                        <label>Constitution?</label>
                        <input type='number' defaultValue={1} min={1} max={9} value={constitution} onChange={e => setConstitution(parseInt(e.target.value))} />
                    </div>
                    <div>
                        <label>Intelligence?</label>
                        <input type='number' defaultValue={1} min={1} max={9} value={intelligence} onChange={e => setIntelligence(parseInt(e.target.value))} />
                    </div>
                    <div>
                        <label>Wisdom?</label>
                        <input type='number' defaultValue={1} min={1} max={9} value={wisdom} onChange={e => setWisdom(parseInt(e.target.value))} />
                    </div>
                    <div>
                        <label>Charisma?</label>
                        <input type='number' defaultValue={1} min={1} max={9} value={charisma} onChange={e => setCharisma(parseInt(e.target.value))} />
                    </div>
                </div>
            </div>
        </form>
